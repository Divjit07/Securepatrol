// Vendored from React Bits (MIT) — reactbits.dev, Animations/GhostCursor.
// Copy-in component, not an npm dependency: edit here, and re-pull from
// github.com/DavidHDev/react-bits if you want upstream changes.
//
// Mount it INSIDE the element it should track: it reads host.parentElement for
// sizing and pointer events, and paints an absolutely-positioned, pointer-events
// -none canvas over it. A parent with pointer-events:none receives no
// pointermove and the trail will never appear.
